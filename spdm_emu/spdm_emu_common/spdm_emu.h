...
#define ADDRESS_Transmit 0x01000
#define ADDRESS_Receive 0x02000
#define ADDRESS_code 0x10000
#define ADDRESS_Context 0x03000
//#define ADDRESS_socket 0x1000
//#define ADDRESS_socket 0x1000
extern uc_engine *uc_requester;
extern uc_engine *uc_responder;
...
#ifndef DEFINE_LIBSPDM_ONEHOT0
bool inline libspdm_onehot0(uint32_t value) {
    return (value != 0) && ((value & (value - 1)) == 0);
}
#define DEFINE_LIBSPDM_ONEHOT0
#else
bool libspdm_onehot0(uint32_t value);
#endif
